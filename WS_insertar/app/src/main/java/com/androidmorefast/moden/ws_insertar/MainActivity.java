...
public class MainActivity extends AppCompatActivity {
        ...
        actualizar.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(!dni.getText().toString().trim().equalsIgnoreCase("")||
                    ...
                    Toast.makeText(MainActivity.this, "Hay información por rellenar",
    ...
    //Actualiza los datos de nuestro servidor
    private boolean actualizar(){
        HttpClient httpclient;
        List<NameValuePair> nameValuePairs;
        HttpPost httppost;
        httpclient=new DefaultHttpClient();
        httppost= new HttpPost("http://192.168.1.33/ws_insertar/actualizar.php"); // Url del Servidor
        ...
        protected String doInBackground(String... params) {
            ...
            if(actualizar())
                context.runOnUiThread(new Runnable(){
                    ...
                    public void run() {
                        // TODO Auto-generated method stub
                        Toast.makeText(context, "Persona actualizada con éxito",
                                Toast.LENGTH_LONG).show();
                        nombre.setText("");
                        dni.setText("");
                        telefono.setText("");
                ...
                context.runOnUiThread(new Runnable(){
                    ...
                    public void run() {
                        // TODO Auto-generated method stub
                        Toast.makeText(context, "Persona no actualizada con éxito",
                                Toast.LENGTH_LONG).show();
                    }
                });
            return null;
    ...
    private boolean validarDni(){
        for (int i = 0; i < listaPersonas.size(); i++) {
            ...
            if(dni.getText().toString().trim().equalsIgnoreCase(p.getDni().toString().trim()))return true;
        }
        runOnUiThread(new Runnable(){
            @Override
            public void run() {
                // TODO Auto-generated method stub
                Toast.makeText(MainActivity.this, "No se puede actualizar el DNI", Toast.LENGTH_LONG).show();
            }
        });
        return false;
    }
